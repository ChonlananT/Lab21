	...
	while(getline(course_file,textline)){
		if(state == 1){
			...
			if(textline == "> Students"){
			    ...
			    if(allcourses.size() == 1) allcourses[0].lecture_list.push_back(textline);
				else if(allcourses.size() == 2) allcourses[1].lecture_list.push_back(textline);
			...
			if(textline == "---------------------------------------"){
				...
				if(allcourses.size() == 1) allcourses[0].student_list.push_back(p);
				else if(allcourses.size() == 2) allcourses[1].student_list.push_back(p);
